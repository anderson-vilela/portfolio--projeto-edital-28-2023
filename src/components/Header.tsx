...
const Header = () => {
  return (
    <header className="fixed left-0 top-0 z-50 flex w-full items-center justify-between gap-8 bg-tw-neutral-0 px-20 py-5 text-xl font-bold text-tw-neutral-400 drop-shadow-md">
      <div>
        <Link href="/home">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          <input
            ...
            className="w-full bg-transparent p-2 text-base text-tw-secundary-color-light outline-none duration-300 placeholder:font-normal placeholder:text-tw-secundary-color group-hover:placeholder:text-tw-primary-color-dark"
          />
        </label>
        <div className="flex items-center gap-4">
